...
class QuestionCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create question_category" do
    assert_difference('QuestionCategory.count') do
      post :create, question_category: { category_id: @question_category.category_id, question_id: @question_category.question_id }
    end
  ...
  test "should show question_category" do
    get :show, id: @question_category
    assert_response :success
  end

  test "should get edit" do
    get :edit, id: @question_category
    assert_response :success
  end

  test "should update question_category" do
    patch :update, id: @question_category, question_category: { category_id: @question_category.category_id, question_id: @question_category.question_id }
    assert_redirected_to question_category_path(assigns(:question_category))
  end
